    ...
    <div style={{ paddingTop: "60px", paddingBottom: "10px" }}>
      ...
      <div className="bg-primary">
        <div className="container">
          <span style={{ color: "white", fontWeight: "bold", textAlign: "left", fontSize: "25px" }}>All Hollywood Movie</span>
...
export default AllHollywoodMovieSee