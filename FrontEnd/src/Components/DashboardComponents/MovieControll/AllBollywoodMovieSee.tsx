    ...
    <div style={{ paddingTop: "60px", paddingBottom: "10px" }}>
      ...
      <div className="bg-primary">
        <div className="container">
          <span style={{ color: "white", fontWeight: "bold", textAlign: "left", fontSize: "25px" }}>All Bollywood Movie</span>
          <span style={{ color: "rgb(255 173 0)", fontWeight: "bold", textAlign: "right", fontSize: "25px" }}> 18</span>
        </div>
      </div>
...
export default AllBollywoodMovieSee