...
const MoviesYouRated = () => {
    ...
    return (<>
        ...
        <div className="" style={{ backgroundImage: `url(${ItMovieBgImg})`, width: "100%", minHeight: "500px", maxHeight: "1000px", backgroundSize: "cover", backgroundPosition: "center", backgroundColor: "#7E635A", backgroundRepeat: "no-repeat" }}>


            <div style={{ paddingBottom:"10px", width: "100%", minHeight: "500px", maxHeight: "1000px", backgroundColor: "#181818ba" }}>
